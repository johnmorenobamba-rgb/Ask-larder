# RSA and service standards

**Applies to:** Duty Manager, Bar Supervisor, Bar Attendant, Glassie

---

## Section 1: RSA at The Quiet Fox
...
This section is context setting and has no check question.

---

## Section 2: Checking ID
...
**Check question:** What's the ID checking rule at The Quiet Fox?
- A. Only check ID if someone asks to open a tab
- B. Check anyone who looks under 25 (correct)
- C. Check anyone who looks under 21
- D. Use your own judgement on a case by case basis

---

## Section 3: Knowing your standard pours
...
**Check question:** What's a standard spirit pour at The Quiet Fox?
- A. 15ml
- B. 30ml (correct)
- C. 45ml
- D. There's no fixed measure

---

## Section 4: Recognising intoxication
...
**Check question:** Which of these is a sign of intoxication staff are trained to watch for?
- A. Ordering a mocktail
- B. Losing track of a conversation mid sentence (correct)
- C. Asking for the bill early
- D. Sitting at the bar alone

---

## Section 5: Refusing service, the right way
...
**Check question:** If a patron argues after being refused service, what should you do?
- A. Keep explaining the refusal yourself until they accept it
- B. Serve them a weaker drink instead
- C. Call Priya or Jordan over immediately (correct)
- D. Ask another Bar Attendant to serve them instead

---

## Section 6: Handling trouble on the floor
