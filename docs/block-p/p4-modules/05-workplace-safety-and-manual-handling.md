...
**Check question:** How should a full keg be lifted from the cool room?
- A. Alone, if you feel strong enough
- B. With a second person, every time (correct)
- C. Only with a trolley, never by hand
- D. However's fastest during a busy shift

---

## Section 2: Collecting glass safely
...
**Check question:** What should you use to collect broken glass?
- A. Bare hands, carefully
- B. A regular broom only
- C. The scoop and rubber lined tubs (correct)
- D. Whatever's closest at the time

---

## Section 3: Handling cleaning chemicals
...
**Check question:** Where should glasswasher detergent and sanitiser be kept?
- A. In their original containers under the back bar (correct)
- B. Decanted into smaller labelled bottles for convenience
- C. Anywhere with space near the glasswasher
- D. Locked away and only accessed by Marcus
...
**Check question:** Who should you report a hazard or near miss to?
- A. Write it in the near miss folder yourself and move on
- B. Whoever's Duty Manager on shift at the time (correct)
- C. Wait until Marcus is next in the venue
- D. Only report it if someone was actually injured
