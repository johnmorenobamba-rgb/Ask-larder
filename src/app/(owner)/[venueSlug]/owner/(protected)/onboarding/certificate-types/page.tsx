...
export default async function CertificateTypesPage({ params }: { params: Promise<{ venueSlug: string }> }) {
  ...
  logQueryError(`[${venueSlug}] onboarding certificate-types certTypes`, certTypesError);
  logQueryError(`[${venueSlug}] onboarding certificate-types profile`, profileError);
