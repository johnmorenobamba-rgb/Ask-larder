...
// 6 Sep 2026: briefly replaced by a baked Remotion video loop, then
// reverted back to the live GSAP cascade (kept scroll-scrubbed 1:1) --
// stations replaces certificates as the 4th real tile.
const CARD_KEYS = ["ring", "continue", "stations", "ask-larder"] as const;
